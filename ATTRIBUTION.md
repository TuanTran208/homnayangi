...
This application continues Nagi / nagisanzenin's Hôm Nay Ăn Gì. Original Git history, authorship and community contributions are preserved. Walter authorized reusing the source, food artwork and data within this project.

The frontend was adapted from the Hôm Nay Ăn Gì web implementation; no private repository Git history is published.
